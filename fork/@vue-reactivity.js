  ...
  return function set(target, key, value, receiver) {
    ...
    if (!shallow) {
      ...
      if (!shared.isArray(target) && isRef(oldValue) && !isRef(value)) {
        ...
        onSetter(target, key, value, receiver)
        return true
      }
    }
    const hadKey =
...
let __getter__ = null
let __setter__ = null
exports.onGetterChange = function (fn) {
  __getter__ = fn
}
exports.onSetterChange = function (fn) {
  __setter__ = fn
}

function onGetter(...args) {
  if (__getter__) {
    __getter__(...args)
  }
}
function onSetter(...args) {
  if (__setter__) {
    __setter__(...args)
  }
}
